        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 30, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Fuels.Admin", null },
                    { 31, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Fuels.Read", null },
                    { 32, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Fuels.Write", null },
                    { 33, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Fuels.Create", null },
                    { 34, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Fuels.Update", null },
                    { 35, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Fuels.Delete", null },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("a8d83760-2f13-4238-9087-4380212ee676"), 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "narch@kodlama.io", new byte[] { 18, 226, 158, 235, 169, 244, 206, 98, 123, 90, 134, 30, 252, 239, 117, 66, 49, 254, 223, 195, 81, 114, 72, 113, 91, 163, 242, 137, 106, 176, 25, 239, 32, 201, 137, 98, 21, 2, 64, 180, 110, 151, 174, 82, 228, 242, 206, 60, 191, 119, 231, 191, 246, 84, 77, 48, 9, 239, 163, 67, 235, 206, 53, 19 }, new byte[] { 121, 255, 242, 134, 122, 122, 3, 62, 117, 116, 204, 0, 191, 173, 144, 208, 70, 74, 228, 234, 216, 214, 161, 18, 236, 130, 206, 184, 243, 231, 93, 20, 230, 4, 94, 33, 140, 154, 119, 111, 164, 1, 135, 23, 146, 169, 109, 170, 152, 145, 52, 105, 224, 148, 227, 143, 95, 153, 15, 154, 56, 179, 130, 128, 188, 193, 221, 187, 215, 123, 178, 32, 168, 192, 248, 53, 121, 61, 239, 231, 20, 132, 181, 125, 78, 45, 245, 160, 17, 131, 19, 58, 132, 131, 179, 199, 42, 35, 27, 153, 230, 45, 120, 200, 198, 41, 243, 26, 158, 31, 199, 95, 247, 40, 218, 180, 161, 242, 231, 92, 236, 60, 8, 165, 176, 253, 139, 105 }, null });

            migrationBuilder.InsertData(
                table: "UserOperationClaims",
                columns: new[] { "Id", "CreatedDate", "DeletedDate", "OperationClaimId", "UpdatedDate", "UserId" },
                values: new object[] { new Guid("4eeb6ef0-ea6f-4fb4-93a8-6624058d3f0d"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 1, null, new Guid("a8d83760-2f13-4238-9087-4380212ee676") });
